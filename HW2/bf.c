...
int main() {
	...
	double point_x, point_y, range, d;
	printf("choose query\n");
	...
	if (query_type == 1) {
		...
		printf("d*0.01 Execution time: %.5lf\n\n", (double)(end - start));
		range = d * 0.02;
		start = clock();
		range_query(range);
		end = clock();
		printf("d*0.02 Execution time: %.5lf\n\n", (double)(end - start));
		range = d * 0.04;
		start = clock();
		range_query(range);
		end = clock();
		printf("d*0.04 Execution time: %.5lf\n\n", (double)(end - start));
		range = d * 0.06;
		start = clock();
		range_query(range);
		end = clock();
		printf("d*0.06 Execution time: %.5lf\n\n", (double)(end - start));
		range = d * 0.08;
		start = clock();
		range_query(range);
		end = clock();
		printf("d*0.08 Execution time: %.5lf\n\n", (double)(end - start));
		range = d * 0.1;
		start = clock();
		range_query(range);
		end = clock();
		printf("d*0.1 Execution time: %.5lf\n\n", (double)(end - start));
...
void knn_query(int k) {
	...
	struct_point *knn = malloc(sizeof(int*)*k);
	for (int i = 0; i < data_size; i++) {
